...
DEVICE = 0
# set parameters
#model_trained_dir=f"{args.dir_output}/m3_shard100_nflows1_nhosts1_nsamples1_lr10Gbps/version_4"
#output_dir=f"./ckpts"
#model_id=""
...
class m3_inference:
    ...
    def run_inference(self,idx):
        ...
        with open(f"{self.dir_data_input}/{spec}/flows.txt", "r") as f:
        ...
        fcts_flowsim = (
            np.load(f"{self.dir_data_input}/{spec}/fct_flowsim.npy") + DELAY_PROPAGATION_PERFLOW
        )
        i_fcts_flowsim = (
