...
extern int totLink; /**< Total number of processing elements */
extern int totRack; /**< Total number of processing elements */
extern int n_pe_per_rack;
extern int nsd_active;

extern int linkid_to_load[MAX_LINK][2];
extern double linkid_to_bw[MAX_LINK][2];
extern double linkid_to_bw_ori[MAX_LINK][2];
extern int linkid_to_fanout[MAX_LINK];
extern int linkid_to_nsd[MAX_LINK][2];
extern int linkid_to_sdid[MAX_LINK][MAX_SD][2];

extern int sd_to_sdid[MAX_RACK][MAX_RACK];
extern int sdid_to_nlink[MAX_SD][2];
extern int sdid_to_linkid[MAX_SD][MAX_NLINK_PER_SD][2];
extern int sdid_to_nflow[MAX_SD];
extern int sdid_to_flowid[MAX_SD][MAX_NFLOWS_PER_SD];
extern int sdid_status[MAX_SD];
extern int sdid_active[MAX_SD];

extern double rate_limit_per_link[MAX_LINK][2];
extern double final_flow_vector[MAX_NFLOW]; // only used in  NON_LP algorithm
